# Generated by Django 4.2.7 on 2024-02-03 20:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zone', models.CharField(choices=[('RESIDENTIAL', 'Residential'), ('COMMERCIAL', 'Commercial'), ('INDUSTRIAL', 'Industrial')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='City',
        ...
        migrations.CreateModel(
            name='FireDepartment',
            fields=[
                ('fire_id', models.AutoField(primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Hospital',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('ROAD', 'Road'), ('TRACKS', 'Tracks'), ('PATH', 'Path')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='User',
